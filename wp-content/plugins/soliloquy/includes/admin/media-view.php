		...
		<script type="text/html" id="tmpl-soliloquy-video-side-bar">
			<div class="media-sidebar">
				<div class="soliloquy-meta-sidebar">
					...
					<p><?php echo wp_kses( 'The image for each video is automatically created from the video link you supply. Video links can be from either YouTube, Vimeo, Wistia or locally hosted video files. They <strong>must</strong> follow one of the formats listed below:', 'soliloquy' ); ?></p>
...
$soliloquy_media_view = Soliloquy_Media_View::get_instance();
