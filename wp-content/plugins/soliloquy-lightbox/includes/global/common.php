...
class Soliloquy_Lightbox_Common {
	 ...
	 */
	public function lightbox_themes() {
		...
		$themes = array(
			...
			array(
				'value' => 'karma',
				'name'  => esc_attr__( 'Karma', 'soliloquy-lightbox' ),
				'file'  => $this->base->file,
			),
	 ...
	 */
	public function lightbox_titles() {
	 ...
	 */
	public function lightbox_transition_effects() {
	 ...
	 */
	public function lightbox_thumbnail_positions() {
