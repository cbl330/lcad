	...
	public function images_display( $post ) {
		...
		<div id="soliloquy-defaults">
			...
			<p class="soliloquy-intro">
				<?php
				esc_html_e( 'This slider and its settings will be used as defaults for any new sliders you create on this site. Any of these settings can be overwritten on an individual slider basis via template tag arguments or shortcode parameters.', 'soliloquy-defaults' );
				?>
			</p>
