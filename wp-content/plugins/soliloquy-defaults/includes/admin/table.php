		...
		if ( isset( get_current_screen()->post_type ) && 'soliloquy' === get_current_screen()->post_type ) {
			...
			<script type="text/javascript">
				jQuery(document).ready(function($){
					$('#post-<?php echo sanitize_html_class( $this->slider_default_id ); ?> .check-column, #post-<?php echo sanitize_html_class( $this->slider_default_id ); ?> .column-shortcode, #post-<?php echo sanitize_html_class( $this->slider_default_id ); ?> .column-template, #post-<?php echo sanitize_html_class( $this->slider_default_id ); ?> .column-images').empty();
				});
			</script>
			<?php
		}
