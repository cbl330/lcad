...
class Soliloquy_Defaults_Common {
	 ...
	 */
	public function get_slider_default_id() {
	...
	public function get_config_defaults( $defaults, $post_id ) {
		...
		if ( function_exists( 'get_current_screen' ) ) {
			...
			if ( is_object( $screen ) && 'add' === $screen->action && 'soliloquy' === $screen->post_type && isset( $_REQUEST['soliloquy_defaults_config_id'] ) ) {
